-- Extended schema for Lead Generation, Subscriptions, Invoices and Trials
...
CREATE TABLE IF NOT EXISTS leads (
  ...
  phone TEXT,
  company TEXT,
  plan_selected TEXT NOT NULL, -- 'basico', 'profesional', 'empresarial'
...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  lead_id TEXT,
  plan TEXT NOT NULL, -- 'basico', 'profesional', 'empresarial'
  price REAL NOT NULL,
...
-- Update users table to track trial/subscription
